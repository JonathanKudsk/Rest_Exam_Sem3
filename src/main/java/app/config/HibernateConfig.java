...
public class HibernateConfig {
    ...
    public static EntityManagerFactory getEntityManagerFactoryForTest() {
        // Tjek om emfTest er null eller lukket - hvis ja, opret en ny
        if (emfTest == null || !emfTest.isOpen()){
            setTest(true);
            emfTest = createEMF(getTest());  // Ingen DB nødvendig for test
        }
        return emfTest;
    }

    // TODO Tilføj Entity klasser her for at de bliver registreret med Hibernate
    ...
    private static Properties setDevProperties(Properties props) {
        // Sæt DB_NAME i din config.properties
    ...
    private static Properties setTestProperties(Properties props) {
        ...
        props.put("hibernate.show_sql", "true");
        props.put("hibernate.hbm2ddl.auto", "create-drop"); // brug "update" for production
        return props;
    }
}
